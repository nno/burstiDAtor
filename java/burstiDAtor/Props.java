...
public class Props {
	...
	public boolean hasKey(String k) { return m.containsKey(k); }
	...
	public void put(String k, double v) { addKey(k); m.put(k,  v); }
	public void put(String k, int v) { addKey(k); m.put(k,  v); }
	public void put(String k, Object v) { addKey(k); m.put(k,  v); }
	
	public Double getD(String k) { return hasKey(k)?
									((Double) m.get(k)):Double.NaN; }
	public Integer getI(String k) { return hasKey(k)?
									((Integer) m.get(k)):Integer.MIN_VALUE; }
	public String getS(String k) { return ((String) m.get(k)); }
